...
public class Employee {
    ...
    public void setInfo(String name, char gender, String jobTitle, String companyName, double salary,
                        String ID,LocalDate hireDate ){
    ...
    //instance methods calls objects methods
    public void getInfo(){
