...
public class CybertekSchool {
    public static void main(String[] args) {
        ...
        cybertekStudents.addAll(Arrays.asList(student1, student2, student3, student4, student5,
                student6,student7,student8,student9,student10));

        Student student11 = new Student();
        Student student12 = new Student();

        student11.setInfo("Lena", 'F', LocalDate.of(2001, 7,12), "L05", 1.3);
        student12.setInfo("Roman", 'M', LocalDate.of(1986, 10,29), "Y45", 1.3);
